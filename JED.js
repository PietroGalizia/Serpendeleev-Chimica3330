...
function generateFood() {
    ...
    document.getElementById('scoreBoard').textContent = `Score: ${score} | ${foodElementNumber}, ${foodElementName}`;
}

// Function to update score
function updateScore(newScore) {
    document.getElementById('scoreBoard').textContent = `Score: ${newScore} | ${foodElementNumber}, ${foodElementName}`;
}
