...
const diets = {
    "Elementi critici": ["He", "Li", "B", "Mg", "P", "Sc", "V", "Cr", "Mn", "Co", "Ni", "Cu", "Zn", "Ga", "Ge", "As", "Se", "Sr", "Y", "Zr", "Nb", "Mo", "Ru", "Rh", "Pd", "Ag", "Cd", "In", "Sn", "Sb", "Te", "Nd", "Dy", "Hf", "Ta", "W", "Os", "Ir", "Pt", "Au", "Hg", "Tl", "Pb", "Bi"],
...
const dietMessages = {
    "Elementi critici": [
        ...
        "I 90 elementi naturali che compongono tutto. Quanto ce n'è? Sarà abbastanza?<br> Dai un'occhiata alla <a href='https://www.euchems.eu/wp-content/uploads/2018/10/Periodic-Table-ultimate-PDF.pdf' target='_blank' style='color: rgb(143, 125, 207);'>Tavola Periodica EuChemS – versione 2.0 del 2023</a>",
        "Non tutti gli elementi sono disponibili in abbondanza. Molti sono a serio rischio nei prossimi 100 anni, altri sono sempre più minacciati a causa dell’aumento della domanda, e diversi elementi attualmente considerati di disponibilità limitata potrebbero affrontare rischi futuri per l’approvvigionamento. Scopri come è cambiata la scarsità degli elementi dal 2019 al 2023. <br>Dai un’occhiata alle <a href='https://www.euchems.eu/euchems-periodic-table/' target='_blank' style='color: rgb(143, 125, 207);'>Tavole Periodiche EuChemS</a>",
        "<a href='https://www.lincei.it/sites/default/files/locandine/Fascicolo%20abstract%20MATERIE%20PRIME%20al%2021.05.2024.pdf' target='_blank' style='color: rgb(143, 125, 207);'>La decrescente disponibilità di alcune materie prime necessarie per nuove tecnologie desta preoccupazioni condivise da comunità scientifiche ed economiche di tutto il mondo. Ci sono rilevanti aspetti chimici nella estrazione, nella purificazione e nel riciclo di molte materie prime critiche. L'argomento è certamente rilevante anche per i mineralogisti e più in generale per i geologi e coinvolge importanti aspetti economici. </a>"
    ],
